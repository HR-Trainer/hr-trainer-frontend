  ...
  return (
    <div className="max-w-4xl space-y-6 pb-12">
          ...
          <div className="flex items-center mt-8 pt-6 border-t border-slate-100 text-center">
            <div className="flex-1">
              <div className="flex items-center justify-center gap-2 text-[#0066FF] mb-1">
                <BookOpen size={18} /> <span className="text-2xl font-black text-slate-900">{stats.formations}</span>
              </div>
            ...
            <div className="flex-1">
              <div className="flex items-center justify-center gap-2 text-emerald-500 mb-1">
                <Clock size={18} /> <span className="text-2xl font-black text-slate-900">{stats.heures}h</span>
              </div>
            ...
            <div className="flex-1">
              <div className="flex items-center justify-center gap-2 text-amber-500 mb-1">
                <Award size={18} /> <span className="text-2xl font-black text-slate-900">{stats.certificats}</span>
              </div>
      ...
      <div className="bg-white rounded-[1.5rem] shadow-sm border border-slate-100 p-8">
        ...
        <form onSubmit={handleUpdate} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div>
              <label className="block text-[13px] font-bold text-slate-800 mb-2">Account Type</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
            ...
            <div>
              <label className="block text-[13px] font-bold text-slate-800 mb-2">Member Since</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                ...
                <input 
                  disabled
                  value="July 2025" // Mocked date for now as per design
                  type="text" 
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-[14px] text-slate-500 font-medium cursor-default" 
                />
              </div>
            </div>
          </div>
      ...
      <div className="bg-red-50/30 rounded-[1.5rem] shadow-sm border border-red-100 p-8">
        ...
        <p className="text-slate-500 text-sm font-medium mb-6">These actions are irreversible. Proceed with caution.</p>
        
        <div className="flex flex-wrap items-center gap-4">
          <button className="px-5 py-2.5 bg-white border border-red-200 text-red-500 rounded-xl font-bold text-sm hover:bg-red-50 transition shadow-sm">
            Delete my account
          </button>
          <button className="px-5 py-2.5 bg-white border border-slate-200 text-slate-600 rounded-xl font-bold text-sm hover:bg-slate-50 transition shadow-sm">
            Export my data
          </button>
        </div>
      </div>
