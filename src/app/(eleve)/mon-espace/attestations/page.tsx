  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900">Mes Attestations</h1>
          <p className="text-slate-500 font-medium text-sm">Téléchargez les certificats de vos formations terminées.</p>
        </div>
      </div>
      ...
      {attestations.length === 0 ? (
        <div className="bg-white rounded-3xl p-12 text-center border border-slate-100 shadow-sm">
          ...
          <h2 className="text-xl font-bold text-slate-800 mb-2">Aucune attestation pour le moment</h2>
          <p className="text-slate-500 mb-6">Vous devez terminer une formation à 100% pour débloquer son attestation.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {attestations.map((att, idx) => (
            <div key={idx} className="bg-white rounded-[2rem] p-6 border border-slate-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
              ...
              <div className="relative z-10 flex flex-col h-full justify-between">
                ...
                <button 
                  ...
                  className="w-full py-3 bg-slate-50 hover:bg-blue-50 text-[#0066FF] font-bold rounded-xl transition flex items-center justify-center gap-2 text-sm border border-slate-100 hover:border-blue-100"
                >
