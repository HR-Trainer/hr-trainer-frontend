        ...
        <div className="space-y-6">
            ...
            return (
              <div key={course.id || idx} className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 py-2">
                ...
                <div className="flex-1 space-y-3">
                  <h4 className="font-bold text-slate-900">{course.titre}</h4>
                ...
                <div className="flex-shrink-0 mt-2 md:mt-0">
                  <Link href={linkHref} className="inline-block px-5 py-2 rounded-xl text-sm font-bold text-[#0066FF] bg-white border border-[#0066FF]/20 hover:bg-blue-50 hover:border-[#0066FF]/40 transition shadow-sm">
          ...
          {data?.availableCourses?.length === 0 && (
            <div className="text-center py-8">
              <p className="text-slate-500 font-medium">No courses are available right now.</p>
            </div>
          )}
        </div>
      </div>
