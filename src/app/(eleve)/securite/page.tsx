...
export default function Securite() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div>
        <h1 className="text-2xl font-extrabold text-slate-900">Account Security</h1>
        <p className="text-slate-500 font-medium text-[15px]">Manage your password and login options</p>
      </div>
      ...
      <div className="bg-white rounded-[1.5rem] shadow-sm border border-slate-100 p-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              <h3 className="font-bold text-slate-900">Current Password</h3>
              <p className="text-sm text-slate-500 mt-1">Last modified 30 days ago • Strength: <span className="font-bold text-emerald-500">Strong</span></p>
            </div>
            <button className="px-5 py-2 border border-slate-200 rounded-xl font-bold text-[#0066FF] text-sm hover:bg-slate-50 transition">
              Change
            </button>
          </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">Not enabled — <span className="font-bold text-slate-700">highly recommended</span></p>
              </div>
            </div>
            {/* Toggle Switch */}
            <button 
            ...
            >
              <span className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-all ${twoFaEnabled ? 'left-7' : 'left-1'}`}></span>
            </button>
          </div>
          
          {/* Active Sessions */}
          <div className="pt-6 border-t border-slate-100">
            <h3 className="font-bold text-slate-900 mb-6">Active Sessions</h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Chrome • macOS</h4>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4 className="font-bold text-slate-900 text-sm">Safari • iPhone</h4>
